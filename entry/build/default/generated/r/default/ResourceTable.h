...
const int32_t STRING_LOCATION_PERMISSION_REASON = 0x01000006;
...
const int32_t MEDIA_CHARGER_ICON = 0x0100000a;
const int32_t MEDIA_FOREGROUND = 0x01000002;
const int32_t MEDIA_LAYERED_IMAGE = 0x01000003;
const int32_t MEDIA_MAP = 0x0100000b;
const int32_t MEDIA_STARTICON = 0x0100000c;
const int32_t PROFILE_BACKUP_CONFIG = 0x0100000d;
const int32_t PROFILE_MAIN_PAGES = 0x0100000e;
}
#endif